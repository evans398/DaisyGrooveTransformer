...
struct UIComponentsManager {
    ...
    std::unique_ptr<UncertaintyPot> uncertainty_pot;
    std::unique_ptr<UncertaintyCVInput> uncertainty_cv_input;
    ...
    std::unique_ptr<GPCV1> gp_cv_1;
    std::unique_ptr<GPCV2> gp_cv_2;
    std::unique_ptr<GPCV3> gp_cv_3;
    ...
    UIComponentsManager(
        ...
        this->uncertainty_cv_input = std::make_unique<UncertaintyCVInput>(2, UNCERTAINTY_CV, uart_libre_manager, hardware_manager);
        ...
        this->gp_cv_1 = std::make_unique<GPCV1>(2, GP_CV_1, uart_libre_manager, hardware_manager);
        this->gp_cv_2 = std::make_unique<GPCV2>(2, GP_CV_2, uart_libre_manager, hardware_manager);
        this->gp_cv_3 = std::make_unique<GPCV3>(2, GP_CV_3, uart_libre_manager, hardware_manager);
    ...
    void ReadUIComponents (){
        ...
        this->uncertainty_cv_input->TransmitNewValue(false);
        ...
        this->gp_cv_1->TransmitNewValue(false);
        this->gp_cv_2->TransmitNewValue(false);
        this->gp_cv_3->TransmitNewValue(false);
